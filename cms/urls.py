...
urlpatterns += patterns(
    ...
    url(r'^signup$', 'signup' if 'ENABLE_LDAP_AUTH' not in settings.FEATURES else 'login_page', name='signup'),
    ...
    url(r'^remove_course/{}$'.format(settings.COURSE_KEY_PATTERN), 'remove_course', name='remove_course'),
