...
(function() {
  ...
  this.Problem = (function() {
    ...
    function Problem(element) {
      ...
      this.checkAnswersAndCheckButton = function(bind) {
        if (bind == null) {
          bind = false;
        }
        return Problem.prototype.checkAnswersAndCheckButton.apply(_this, arguments);
      };
    ...
    Problem.prototype.bind = function() {
      ...
      if (this.checkButton.length) {
        this.checkAnswersAndCheckButton(true);
      }
    ...
    */
    ...
    Problem.prototype.checkAnswersAndCheckButton = function(bind) {
        ...
        if ($(text_field).is(':visible')) {
          ...
          if (bind) {
            $(text_field).on('input', function(e) {
              _this.checkAnswersAndCheckButton();
            });
          }
        }
      });
      ...
      if (answered) {
        ...
        return this.enableCheckButton(false, false);
      }
    };
