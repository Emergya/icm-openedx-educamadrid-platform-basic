...
(function (globals) {
  ...
  django.catalog = {
    ...
    " learner is already white listed and not added to the exception ": "estudiante no existe en el LMS y no se ha a\u00f1adido a la lista de excepci\u00f3n", 
    " learner is not enrolled in course and not added to the exception": "estudiante no existe en el LMS y no se ha a\u00f1adido a la lista de excepci\u00f3n", 
    " learner is successfully added to the exception list": "estudiante es a\u00f1adido satisfactoriamente a la lista de excepci\u00f3n", 
    " learners are not enrolled in course and not added to": "estudiante no existe en el LMS y no se ha a\u00f1adido a la lista de excepci\u00f3n", 
    " learners are successfully added to exception list": "estudiantes son a\u00f1adidos satisfactoriamente a la lista de excepci\u00f3n", 
    " learners do not exist in LMS and not added to the": "estudiante no existe en el LMS y no se ha a\u00f1adido a la lista de excepci\u00f3n", 
    " record is not in correct format and not added to the exception": "estudiante no existe en el LMS y no se ha a\u00f1adido a la lista de excepci\u00f3n", 
    "#Replies": "#Respuestas", 
    ...
    "An error occurred.": "Hubo un error. Por favor carga la p\u00e1gina de nuevo.", 
    ...
    "By: Community TA": "TA de la comunidad", 
    "By: Staff": "Equipo", 
    ...
    "Change the settings for %(display_name)s": "\u00bfDeseas borrar %(item_display_name)s?", 
    ...
    "Click to add": "Clic para modificar", 
    ...
    "Click to remove": "Clic para modificar", 
    "Close": "Cerrar", 
    ...
    "Collapse discussion": "Ver debate", 
    ...
    "Delete this %(xblock_type)s?": "\u00bfDeseas borrar %(item_display_name)s?", 
    ...
    "Deleting this %(xblock_type)s is permanent and cannot be undone.": "%(item_display_name)s se eliminar\u00e1 de forma permanente y no se puede deshacer.", 
    "Deprecated": "Obsoleto", 
    ...
    "Edit post title": "Editando entrada", 
    ...
    "Error deleting student '<%= student_id %>'s state on problem '<%= problem_id %>'. Make sure that the problem and student identifiers are complete and correct.": "Error al comenzar una tarea de re-evaluaci\u00f3n del examen inicial para el alumno '{student_id}'. Aseg\u00farate de que el examen inicial tiene ejercicios y el identificador de alumno es correcto.", 
    ...
    "Error getting student progress url for '<%= student_id %>'. Make sure that the student identifier is spelled correctly.": "Error al obtener el historial de la tarea del examen inicial para el alumno '{student_id}'. Aseg\u00farate de que el identificador del alumno es correcto.", 
    "Error getting task history for problem '<%= problem_id %>' and student '<%= student_id %>'. Make sure that the problem and student identifiers are complete and correct.": "Error al comenzar una tarea de re-evaluaci\u00f3n del examen inicial para el alumno '{student_id}'. Aseg\u00farate de que el examen inicial tiene ejercicios y el identificador de alumno es correcto.", 
    ...
    "Error resetting problem attempts for problem '<%= problem_id %>' and student '<%= student_id %>'. Make sure that the problem and student identifiers are complete and correct.": "Error reseteando los intentos del examen inicial para el alumno '{student_id}'. Aseg\u00farate de que el identificador del alumno es correcto.", 
    ...
    "Error starting a task to rescore problem '<%= problem_id %>' for student '<%= student_id %>'. Make sure that the the problem and student identifiers are complete and correct.": "Error al comenzar una tarea de re-evaluaci\u00f3n del examen inicial para el alumno '{student_id}'. Aseg\u00farate de que el examen inicial tiene ejercicios y el identificador de alumno es correcto.", 
    "Error starting a task to rescore problem '<%= problem_id %>'. Make sure that the problem identifier is complete and correct.": "Error al comenzar una tarea de re-evaluaci\u00f3n del examen inicial para el alumno '{student_id}'. Aseg\u00farate de que el examen inicial tiene ejercicios y el identificador de alumno es correcto.", 
    "Error starting a task to reset attempts for all students on problem '<%= problem_id %>'. Make sure that the problem identifier is complete and correct.": "Error al comenzar una tarea de re-evaluaci\u00f3n del examen inicial para el alumno '{student_id}'. Aseg\u00farate de que el examen inicial tiene ejercicios y el identificador de alumno es correcto.", 
    ...
    "Error: User '<%= username %>' has not yet activated their account. Users must create and activate their accounts before they can be assigned a role.": "Los usuarios tienen que crear y activar sus cuentas antes de que se les pueda asignar el rol de probadores de beta.", 
    ...
    "Expand discussion": "Buscar conversaciones", 
    ...
    "Linked Accounts": "Cuentas asociadas", 
    "Linking": "Enlazando", 
    ...
    "Loading thread list": "Cargando m\u00e1s conversaciones", 
    ...
    "ORDER PLACED": "PEDIDOS REALIZADOS", 
    "Ok": "De acuerdo", 
    ...
    "Public": "P\u00fablico", 
    "Publish": "Publicar", 
    "Publish %(display_name)s": "\u00bfDeseas borrar %(item_display_name)s?", 
    ...
    "Status": "Estado", 
    "Status: unsubmitted": "Enviado", 
    "Strikethrough": "Barra", 
    "Student": "Alumno", 
    "Student username/email field is required and can not be empty. ": "El campo de nombre de usuario/email del estudiante es obligatorio y no puede estar vac\u00edo. Por favor, escriba el nombre de usuario/email y  pulse el bot\u00f3n \"A\u00f1adir a la lista de excepci\u00f3n\".", 
    ...
    "This page contains information about orders that you have placed with {platform_name}.": "Esta p\u00e1gina contiene informaci\u00f3n sobre pedidos que has realizado en {platform_name}.", 
    ...
    "URL": "URL", 
    "Unable to retrieve data, please try again later.": "Se ha producido un error. Por favor, int\u00e9ntalo de nuevo m\u00e1s tarde.", 
    "Underline": "Subrayado", 
    "Undo": "Atr\u00e1s", 
    ...
    "View/Share Certificate": "Ver certificado", 
    "Viewing %s course": [
      "Viendo %s curso", 
      "Viendo %s cursos"
    ], 
    ...
    "Warning": "Aviso", 
    "Warnings": "Avisos", 
    "We couldn't create your account.": "Crea tu cuenta", 
    "We couldn't find any results for \"%s\".": "No se encuentran resultados para \"%s\".", 
    "We had some trouble closing this thread.  Please try again.": "Algo ha ido mal al modificar esta inscripci\u00f3n. Por favor, int\u00e9ntalo de nuevo.", 
    "We had some trouble deleting this comment. Please try again.": "Algo ha ido mal al modificar esta inscripci\u00f3n. Por favor, int\u00e9ntalo de nuevo.", 
    "We had some trouble loading more responses. Please try again.": "Error al generar el informe de las notas de los problemas. Por favor int\u00e9ntelo m\u00e1s tarde.", 
    "We had some trouble loading more threads. Please try again.": "Se ha producido un error, por favor int\u00e9ntalo de nuevo", 
    "We had some trouble loading responses. Please reload the page.": "Se ha producido un error, por favor int\u00e9ntalo de nuevo y recarga la p\u00e1gina", 
    "We had some trouble loading the discussion. Please try again.": "Algo ha ido mal al modificar esta inscripci\u00f3n. Por favor, int\u00e9ntalo de nuevo.", 
    "We had some trouble marking this response endorsed.  Please try again.": "Algo ha ido mal al modificar esta inscripci\u00f3n. Por favor, int\u00e9ntalo de nuevo.", 
    "We had some trouble pinning this thread. Please try again.": "Algo ha ido mal al modificar esta inscripci\u00f3n. Por favor, int\u00e9ntalo de nuevo.", 
    "We had some trouble processing your request. Please try again.": "Se ha producido un error, por favor int\u00e9ntalo de nuevo", 
    "We had some trouble removing this endorsement.  Please try again.": "Algo ha ido mal al modificar esta inscripci\u00f3n. Por favor, int\u00e9ntalo de nuevo.", 
    "We had some trouble removing your flag on this post.  Please try again.": "Algo ha ido mal al modificar esta inscripci\u00f3n. Por favor, int\u00e9ntalo de nuevo.", 
    "We had some trouble reopening this thread.  Please try again.": "Algo ha ido mal al modificar esta inscripci\u00f3n. Por favor, int\u00e9ntalo de nuevo.", 
    "We had some trouble reporting this post.  Please try again.": "Algo ha ido mal al modificar esta inscripci\u00f3n. Por favor, int\u00e9ntalo de nuevo.", 
    "We had some trouble saving your vote.  Please try again.": "Se ha producido un error, por favor int\u00e9ntalo de nuevo", 
    "We had some trouble unpinning this thread. Please try again.": "Algo ha ido mal al modificar esta inscripci\u00f3n. Por favor, int\u00e9ntalo de nuevo.", 
    ...
    "When you select \"Reset Your Password\", a message will be sent to the email address for your {platform_name} account. Click the link in the message to reset your password.": "Cuando seleccionas \"Restablece tu contrase\u00f1a\", un correo ser\u00e1 enviado a tu direcci\u00f3n de correo electr\u00f3nico de tu cuenta de {platform_name}. Haz click en el enlace de ese correo para restablecer tu contrase\u00f1a.", 
    ...
    "Words: {0}": "Palabras: {0}", 
    "XSeries Program Certificates": "Ver certificado", 
    ...
    "You are not enrolled in any XSeries Programs yet.": "Acabas de ser inscrito como alumno verificado para:", 
    "You are now enrolled as a verified student for:": "Acabas de ser inscrito como alumno verificado para:", 
    "You can link your social media accounts to simplify signing in to {platform_name}.": "Puedes enlazar tus cuentas de redes sociales para simplificar el inicio de sesi\u00f3n en {platform_name}.", 
    ...
    "You can pay now even if you don't have the following items available, but you will need to have these by %(date)s to qualify to earn a Verified Certificate.": "Puedes pagar ahora aunque no tengas disponibles los siguientes puntos, pero necesitar\u00e1s tenerlos para el %(date)s para tener la opci\u00f3n de conseguir un Certificado Verificado.", 
    ...
    "Your request could not be completed due to a server problem. Reload the page": "Tu solicitud no puede ser realizada. Recarga la p\u00e1gina e int\u00e9ntalo de nuevo.", 
    ...
    "e.g. 'http://google.com/'": "p.ej. 'google'", 
